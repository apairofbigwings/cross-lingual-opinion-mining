...
Original file is located at
    https://colab.research.google.com/drive/13ZfxbbJJnvIXhLXciyH-zKUoYGJJDqxl
"""
...
# Reference: matplotlib Radar chart (aka spider or star chart)
...
def show_simple_radar_chart(clusters, data, colors, labels, title, ymax = 25, ymin = 0):
  k = len(clusters)
  theta = radar_factory(k, frame = 'polygon')
  fig, axes = plt.subplots(figsize = (18, 18), subplot_kw = dict(projection = 'radar'))
